...
class HeisenbergModelX(LatticeModel):
    """The Heisenberg model."""
    ...
    def second_q_ops(self, display_format: Optional[str] = None) -> SpinOp:
        ...
        for node_a, node_b, weight in weighted_edge_list:
            if node_a == node_b:
                index = node_a
                ham_x.append((f"X_{index}", weight))
                ...
                ham_x.append((f"X_{index_left} X_{index_right}", coupling_parameter))
        return SpinOp(ham_x, spin=Fraction(1, 2), register_length=register_length)
    
class HeisenbergModelY(LatticeModel):
    """The Heisenberg model."""
    ...
    def second_q_ops(self, display_format: Optional[str] = None) -> SpinOp:
        ...
        for node_a, node_b, weight in weighted_edge_list:
            if node_a == node_b:
                index = node_a
                ham_y.append((f"Y_{index}", weight))
                ...
                ham_y.append((f"Y_{index_left} Y_{index_right}", coupling_parameter))
        return SpinOp(ham_y, spin=Fraction(1, 2), register_length=register_length)

class HeisenbergModelZ(LatticeModel):
    """The Heisenberg model."""
    ...
    def second_q_ops(self, display_format: Optional[str] = None) -> SpinOp:
        ...
        for node_a, node_b, weight in weighted_edge_list:
            if node_a == node_b:
                index = node_a
                ham_z.append((f"Z_{index}", weight))
                ...
                ham_z.append((f"Z_{index_left} Z_{index_right}", coupling_parameter))
        return SpinOp(ham_z, spin=Fraction(1, 2), register_length=register_length)